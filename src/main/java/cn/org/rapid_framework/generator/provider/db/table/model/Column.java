...
public class Column implements java.io.Serializable,Cloneable{
	 ...
	 * **/
	public String strToUnicode(String gbStr) {
...
//	}
	...
	public String getUnicodeBytes() {
		unicodeBytes=this.getColumnAlias();
		return strToUnicode(unicodeBytes);
	}

	public void setUnicodeBytes(String unicodeBytes) {
		this.unicodeBytes = unicodeBytes;
	}
